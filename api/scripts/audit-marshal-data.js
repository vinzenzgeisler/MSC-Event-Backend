    ...
    const report = {
      ...
      ...(importRepairSource ? {
        importRepairSource: {
          ...
          historicalClubMemberCandidatesMatchingImportBug: sourceDiffs.filter((row) => row.clubMemberSafe).length,
          otherClubMemberDifferences: sourceDiffs.filter((row) => row.clubMemberChanged && !row.clubMemberSafe).length,
