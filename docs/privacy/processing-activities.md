...
| Oeffentliche Anmeldung | Entgegennahme von Nennungen | Fahrer, Beifahrer, Notfallkontakte, bei Minderjaehrigen auch Sorgeberechtigte | Identitaets-, Kontakt-, Fahrzeug-, Notiz-, Consent-Daten | Art. 6 Abs. 1 lit. b; fuer optionale Mediennutzung lit. a | Interne Admin-Nutzer, IT-Provider | 1 Jahr nach Eventende fuer personenbezogene Anmeldedaten | Eventende + 1 Jahr, soweit keine laengeren gesetzlichen Pflichten bestehen | Input-Validierung, Audit, DB-Constraints, eventbezogene Anonymisierung |
...
| Dokumenterzeugung (Waiver/Tech Check) | Bereitstellung unterschrifts-/pruefrelevanter Unterlagen | Fahrer, Beifahrer | Dokumentmetadaten, PDF-Inhalte, Hash, S3-Key | Art. 6 Abs. 1 lit. b, lit. f | Interne Nutzer, AWS S3 | 6 Jahre nach Eventende | Frist erreicht | Hash-Speicherung, presigned URL, Bucket Encryption |
...
| Check-in und technische Abnahme | Veranstaltungsdurchfuehrung und Sicherheit | Fahrer, Beifahrer | Verifikationsstatus, Tech-Status, Bearbeiterkennung | Art. 6 Abs. 1 lit. b, lit. f | Interne Check-in/Technikrollen | 1 Jahr fuer personenbezogene Anmeldedaten; laengere Fristen nur fuer Dokumente, Zahlungen und Audit | Eventende + 1 Jahr bzw. jeweilige Spezialfrist | RBAC, Audit-Log, Datenminimierung in Views |
