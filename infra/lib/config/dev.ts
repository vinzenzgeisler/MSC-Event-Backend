...
const baseDevConfig: Omit<StageConfig, 'enableRds' | 'enableApi' | 'enableMigrationRunner' | 'apiInVpc' | 'dbConnectivityMode' | 'dbUseIamAuth' | 'dbPublicAccess'> = {
  ...
  aiBedrockModelId: 'eu.amazon.nova-micro-v1:0',
  aiInboxImapSecretArn: 'arn:aws:secretsmanager:eu-central-1:195275675655:secret:dreiecksrennen-dev/ai/inbox-imap-1gE3Fs',
  aiInboxImapMailbox: 'INBOX',
  aiInboxImapMailboxKey: 'dreiecksrennen-dev-imap',
